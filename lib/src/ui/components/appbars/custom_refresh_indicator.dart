            ...
            child: Container(
              ...
              child: ScaleTransition(
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      padding: AppDimensions.symmetricH12V3,
                      ...
                      child: Center(
                        child: Text(
                          context.l10n.dragDownToRefresh,
                          style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: AppColors.colorFFFFFF, fontSize: 18.sp),
                          maxLines: 1,
                        ),
                      ),
                    ),
